...
import { SqlcIndex } from './posindex';
...
export async function activate(context: vscode.ExtensionContext) {
	...
	const disposable = vscode.commands.registerCommand('sqlc.helloWorld', () => {
		// The code you place here will be executed every time your command is executed
		// Display a message box to the user
		vscode.window.showInformationMessage('Hello World from sqlc!');
	});
...
//         pos,
//         locs,
//         'goto' // or 'peek' – 'goto' shows the peek UI here
//       );
//     } else {
